                    ...
                    <tbody>
                        <tr v-for="(area, i) in arias.data" :key="area.id">
                            ...
                            <td>
                                ...
                                <router-link to="#" class="btn btn-sm btn-clean btn-icon" title="Edit details">
                    ...
                    <div class="card-body">
                        <form @submit.prevent="saveNewArea">
                            ...
                            <div class="mb-1">
                                ...
                                <input class="form-control readonly" v-model="createForm.delivery_charge" type="text"
                            ...
                            <div class="mb-1">
                                ...
                                <input class="form-control readonly" v-model="createForm.charge_condition" type="text"
                            ...
                            <div class="mb-1">
                                ...
                                <input class="form-control readonly" v-model="createForm.charge_condition_price" type="text"
                                    placeholder="e.g Charge Condition price" />
