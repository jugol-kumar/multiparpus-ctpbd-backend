    ...
    <section>
        ...
        <div class="row">
            <div class="col-md-3 d-flex flex-column gap-2">
                ...
                <div class="card cursor-pointer" :class="{'bg-primary text-white fw-bolder' : currentTab === 'seo'}"
...
<!--                                <Editor v-model="details" height="400px"/>-->
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card" v-if="currentTab === 'variants'">
                    <div class="card-header py-3 d-flex flex-row align-items-center gap-2">
                        ...
                        <div class="row" v-for="(item,index) in product_variant">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <!--                                    <select v-model="item.tags" @change="checkVariant" class="form-control" multiple="true">-->
                                    <!--                                        <option selected disabled >Select Variations Options</option>-->
                                    <!--                                        <option v-for="variant in variationValues[index]"-->
                                    <!--                                                :value="variant">-->
...
<!--                                    :options="variationValues[index]"-->
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body border">
                                &lt;!&ndash;                        <vue-dropzone ref="myVueDropzone" id="dropzone" :options="dropzoneOptions"&ndash;&gt;
                                &lt;!&ndash;                                      @vdropzone-success="uploaded"&ndash;&gt;
                                &lt;!&ndash;                                      @vdropzone-file-added="addfile">&ndash;&gt;

                                &lt;!&ndash;                        </vue-dropzone>&ndash;&gt;
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row" v-for="(item,index) in product_variant">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select v-model="item.option" @change="changeVariation(index)" class="form-control">
                                                <option v-for="variant in variants"
                                                        :value="variant.id">
                                                    {{ variant.name+'-&#45;&#45;'+variant.id }}
                                                </option>
        ...
        &lt;!&ndash;
                                                        :value="{id:variant.id, name:variant.name} // this is for only id of varient&ndash;&gt;
                                            </select>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody v-if="product_variant_prices.length > 0">
                                            <tr v-for="variant_price in product_variant_prices">
                                                <td>{{ variant_price.title }}</td>
                                                <td>
                                                    <input type="number" min="100" max="500" class="form-control" v-model="variant_price.price">
                                                </td>
                                                <td>
                                                    <input type="number" min="10" max="50" class="form-control" v-model="variant_price.stock">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                ...
                <button type="submit" @click="saveProduct" class="btn btn-lg btn-primary">Save</button>
