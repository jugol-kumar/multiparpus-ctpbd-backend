    ...
    <div>
        ...
        <div class="d-flex flex-column flex-root">
            ...
            <div class="d-flex flex-row flex-column-fluid page">
                <!--begin::Aside-->
                <div v-show="$route.path == '/' ? false : true" style="display: none!important;"
                     class="aside aside-left aside-fixed flex-column flex-row-auto" id="kt_aside">
                    <!--begin::Brand-->
            ...
            <span class="svg-icon svg-icon svg-icon-xl">
                                ...
                                <span class="svg-icon menu-icon">
                                    ...
                                    <div class="menu-submenu">
                                        <ul class="menu-subnav">
                                            ...
                                            <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                                data-menu-toggle="hover">
                                                <router-link :to="{name:'ManageEmployee'}"
                                ...
                                <span class="svg-icon menu-icon">
                                    ...
                                    <div class="menu-submenu">
                                        <ul class="menu-subnav">
                                            ...
                                            <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                                data-menu-toggle="hover">
                                                <router-link :to="{name:'ManageCustomer'}"
                                                             class="menu-link menu-toggle">
                                                    <i class="menu-bullet menu-bullet-line">
                                                        <span></span>
                                                    </i>
                                ...
                                <span class="svg-icon menu-icon">
                                    ...
                                    <div class="menu-submenu">
                                        <ul class="menu-subnav">
                                            ...
                                            <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                                data-menu-toggle="hover">
                                                <router-link :to="{name:'ManageSupplier'}"
                                                             class="menu-link menu-toggle">
                                                    <i class="menu-bullet menu-bullet-line">
                                                        <span></span>
                                                    </i>
                                ...
                                <span class="svg-icon menu-icon">
                                    ...
                                    <div class="menu-submenu">
                                        <ul class="menu-subnav">
                                            <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                                data-menu-toggle="hover">
                                                <router-link :to="{name:'MediVariations'}"
                                                             class="menu-link menu-toggle">
                                                    <i class="menu-bullet menu-bullet-line">
                                                        <span></span>
                                                    </i>
                                            ...
                                            <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                                data-menu-toggle="hover">
                                                <router-link :to="{name:'ProductVariations'}"
                                                             class="menu-link menu-toggle">
                                                    <i class="menu-bullet menu-bullet-line">
                                                        <span></span>
                                                    </i>
                ...
                <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper" style="padding-top:65px;">
                    <!--begin::Header-->
                    <div style="display: none;" id="kt_header" v-show="$route.path === '/' ? false : true"
                                        ...
                                        <form>
                                            ...
                                            <div
                                                ...
                                                <ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-line-transparent-white nav-tabs-line-active-border-success mt-3 px-8"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab"
                                                           href="#topbar_notifications_logs">Messages</a>
                                                    </li>
                                                </ul>
                                                <!--end::Tabs-->
                                            </div>
                                                        ...
                                                        <span class="symbol-label">
                                                            <span class="svg-icon svg-icon-lg svg-icon-warning">
                                                                ...
                                                                <svg xmlns="http://www.w3.org/2000/svg" height="1em"
                                                                     viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path
